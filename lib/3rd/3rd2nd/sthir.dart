...
import 'package:untitled/3rd/3rd2nd/sih.dart';
import 'package:untitled/3rd/3rd2nd/sim.dart';
import 'package:untitled/3rd/3rd2nd/simu.dart';
import 'package:untitled/3rd/3rd2nd/sis.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../botmbuton.dart';

class SecThir extends StatefulWidget {
  const SecThir({Key key}) : super(key: key);

  @override
  State<SecThir> createState() => _SecThirState();
}

class _SecThirState extends State<SecThir> {
  @override
          ...
          children: [
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 120),
                  Image.asset('assets/images/sisr.jpeg'),
                  SizedBox(height: 80),
                ],
              ),
            ),
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=>Sihaz()));
                },
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Sisoar()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=>Simjlis()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>Simuq()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
