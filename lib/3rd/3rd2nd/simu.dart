...
class Simuq extends StatefulWidget {
  const Simuq({Key key}) : super(key: key);

  @override
  State<Simuq> createState() => _SimuqState();
}

class _SimuqState extends State<Simuq> {
  @override
            ...
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 30),
                  Image.asset('assets/images/hbmukmt 1.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/hbmukmt2.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/hbmukmt3.jpeg'),
                ],
              ),
            ),
            Container(
