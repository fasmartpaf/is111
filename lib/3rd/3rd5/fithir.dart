...
import 'package:untitled/3rd/3rd5/shhhazrat.dart';
import 'package:untitled/3rd/3rd5/shhmjalis.dart';
import 'package:untitled/3rd/3rd5/shhmwakib.dart';
import 'package:untitled/3rd/3rd5/shhsoar.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../botmbuton.dart';

class FifThi extends StatefulWidget {
  const FifThi({Key key}) : super(key: key);

  @override
  State<FifThi> createState() => _FifThiState();
}

class _FifThiState extends State<FifThi> {
  @override
          ...
          children: [
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 120),
                  Image.asset('assets/images/shhs.jpeg'),
                  SizedBox(height: 80),
                ],
              ),
            ),
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=>ShhHazrat()));
                },
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>ShhSoar()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
               Navigator.push(context, MaterialPageRoute(builder: (context)=>ShhMjalis()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ShhMwakib()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
