...
import 'package:untitled/3rd/3rd4/sihhaz.dart';
import 'package:untitled/3rd/3rd4/sihmajlis.dart';
import 'package:untitled/3rd/3rd4/sihmuqam.dart';
import 'package:untitled/3rd/3rd4/sihmwakib.dart';
import 'package:untitled/3rd/3rd4/sihsoar.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../botmbuton.dart';

class ForThir extends StatefulWidget {
  const ForThir({Key key}) : super(key: key);

  @override
  State<ForThir> createState() => _ForThirState();
}
class _ForThirState extends State<ForThir> {
  @override
          ...
          children: [
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 120),
                  Image.asset('assets/images/sihs.jpeg'),
                  SizedBox(height: 80),
                ],
              ),
            ),
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=>SihHazrat()));
                },
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>SihSoar()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=>SihMajlis()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              margin: EdgeInsets.only(left: 60,right: 60),
              child: RaisedButton(
                child: Text("مواكب", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                onPressed: (){
                   Navigator.push(context, MaterialPageRoute(builder: (context)=>SihMuwakib()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>SihMuqam()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
