...
class SihMuqam extends StatefulWidget {
  const SihMuqam({Key key}) : super(key: key);

  @override
  State<SihMuqam> createState() => _SihMuqamState();
}

class _SihMuqamState extends State<SihMuqam> {
  @override
            ...
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 30),
                  Image.asset('assets/images/ihmuq1.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/ihmuq2.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/ihmuq3.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/ihmuq4.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/ihmuq5.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/ihmuq6.jpeg'),
                ],
              ),
            ),
            Container(
