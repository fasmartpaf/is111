...
import 'package:untitled/3rd/3rd1st/Firmuqam.dart';
import 'package:untitled/3rd/3rd1st/firsoar.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../botmbuton.dart';

class Firstthi extends StatefulWidget {
  const Firstthi({Key key}) : super(key: key);

  @override
  State<Firstthi> createState() => _FirstthiState();
}
class _FirstthiState extends State<Firstthi> {
  @override
          ...
          children: [
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 120),
                  Image.asset('assets/images/ssr.jpeg'),
                  SizedBox(height: 80),
                ],
              ),
            ),
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>FirSoar()));
                },
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>FirsMuq()));
                },
                color: Color(0xffFCBB31),
                textColor: Color(0xff024000),
                padding: EdgeInsets.all(8.0),
