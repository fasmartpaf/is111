...
class EightHome extends StatefulWidget {
  const EightHome({Key key}) : super(key: key);

  @override
  State<EightHome> createState() => _EightHomeState();
}

class _EightHomeState extends State<EightHome> {
  @override
            ...
            Container(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 30),
                  Image.asset('assets/images/81.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/82.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/83.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/84.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/85.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/86.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/87.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/88.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/89.jpeg'),
                  SizedBox(height: 20),
                  Image.asset('assets/images/90.jpeg'),
                ],
              ),
            ),
            Container(
